...
//pgmspace fixup
#if defined(__MK20DX128__) || defined(__MK20DX256__) || defined(__MKL26Z64__) || defined(__MK66FX1M0__)//teensy 3 or 3.1 or LC
...
//------------- Instance -------------------------
	#if defined(__MK20DX128__) || defined(__MK20DX256__) || defined(__MK66FX1M0__)//Teensy 3.0, Teensy 3.1
		#if defined (USE_FT5206_TOUCH)//with FT5206_TOUCH
			RA8875(const uint8_t CSp,const uint8_t RSTp=255,const uint8_t INTp=2,const uint8_t mosi_pin=11,const uint8_t sclk_pin=11,const uint8_t miso_pin=12);
		#else
...
//--------------Text functions ------------------------------
	...
	void		setTextXY(int16_t x, int16_t y,bool update);
	void    	outChar(uint8_t text);
